...
fn increment_single_frame() {
    ...
    view.handle_event(
        &buoyant::view::Event::TouchDown(Point::new(1, 1)),
        &mut tree,
        &mut app_state,
        &mut view_state,
    );
    assert_eq!(app_state, AppState { a: 0, b: 0 });
    view.handle_event(
        &buoyant::view::Event::TouchUp(Point::new(1, 1)),
        &mut tree,
        &mut app_state,
        &mut view_state,
    );
...
fn drag_cancel() {
    ...
    assert_eq!(app_state, AppState { a: 0, b: 0 });
    view.handle_event(
        &buoyant::view::Event::TouchMoved(Point::new(1, 2)),
        &mut tree,
        &mut app_state,
        &mut view_state,
    );
    assert_eq!(app_state, AppState { a: 0, b: 0 });
    view.handle_event(
        &buoyant::view::Event::TouchUp(Point::new(1, 2)),
        &mut tree,
        &mut app_state,
        &mut view_state,
    );
...
fn drag_cancel_uncancel() {
    ...
    assert_eq!(app_state, AppState { a: 0, b: 0 });
    view.handle_event(
        &buoyant::view::Event::TouchMoved(Point::new(5, 1)),
        &mut tree,
        &mut app_state,
        &mut view_state,
    );
    assert_eq!(app_state, AppState { a: 0, b: 0 });
    view.handle_event(
        &buoyant::view::Event::TouchUp(Point::new(5, 1)),
        &mut tree,
        &mut app_state,
        &mut view_state,
    );
